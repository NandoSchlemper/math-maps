...
func LoadRows(dados entities.Response) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<table><thead><tr><th>ID</th><th>Placa</th><th>Status</th></tr></thead> <tbody>")
		if templ_7745c5c3_Err != nil {
		...
		for _, placa := range dados.Dados {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(placa.Status)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `frontend/components/position/plate_informations.templ`, Line: 32, Col: 33}
			}
